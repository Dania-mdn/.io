...
Shader "DissloveAndGlow"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_VFX_BulletLines("VFX_BulletLines", 2D) = "white" {}
		_GlowColor("GlowColor", Color) = (1,0.5773492,0,0)
		_Emission("Emission", Float) = 1
		[ASEEnd]_GlowIntensity("GlowIntensity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_VFX_BulletLines = IN.ase_texcoord7.xy * _VFX_BulletLines_ST.xy + _VFX_BulletLines_ST.zw;
				float4 tex2DNode8 = tex2D( _VFX_BulletLines, uv_VFX_BulletLines );
				float4 color13 = IsGammaSpace() ? float4(1,0.8135679,0,0) : float4(1,0.6270803,0,0);
				float4 lerpResult12 = lerp( color13 , ( tex2DNode8.g * IN.ase_color ) , tex2DNode8.g);
				float4 temp_output_17_0 = ( ( _GlowColor * _GlowIntensity * ( tex2DNode8.r + 0.0 ) ) + ( tex2DNode8.g * lerpResult12 ) );
				
				float3 Albedo = temp_output_17_0.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _Emission * temp_output_17_0 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( tex2DNode8.r + tex2DNode8.g );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_VFX_BulletLines = IN.ase_texcoord2.xy * _VFX_BulletLines_ST.xy + _VFX_BulletLines_ST.zw;
				float4 tex2DNode8 = tex2D( _VFX_BulletLines, uv_VFX_BulletLines );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_VFX_BulletLines = IN.ase_texcoord3.xy * _VFX_BulletLines_ST.xy + _VFX_BulletLines_ST.zw;
				float4 tex2DNode8 = tex2D( _VFX_BulletLines, uv_VFX_BulletLines );
...
/*ASEBEGIN
Version=18900
1942;832;1793;879;463.0066;46.35246;1.681287;True;True
Node;AmplifyShaderEditor.SamplerNode;8;-1244.703,178.8183;Inherit;True;Property;_VFX_BulletLines;VFX_BulletLines;0;0;Create;True;0;0;0;False;0;False;-1;358741e2b15384e41a8dbdc559417beb;358741e2b15384e41a8dbdc559417beb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;14;-1057.525,517.481;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-708.4312,403.3555;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;13;-899.7613,159.9976;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,0.8135679,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;12;-463.3965,265.733;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-614.9047,45.18413;Inherit;False;Property;_GlowIntensity;GlowIntensity;3;0;Create;True;0;0;0;False;0;False;1;6.66;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;19;-895.2288,-436.3348;Inherit;False;Property;_GlowColor;GlowColor;1;0;Create;True;0;0;0;False;0;False;1,0.5773492,0,0;1,0.5769231,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;9;-788.84,-165.5222;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-482.2288,-180.3348;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-206.6789,188.8775;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;197.015,74.23444;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;22;364.6453,-92.62308;Inherit;False;Property;_Emission;Emission;2;0;Create;True;0;0;0;False;0;False;1;13.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;1023.99,362.477;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;556.4358,139.7701;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-470.1251,589.1775;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;24;748.7992,448.7786;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;49.43;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1319.832,37.03522;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;DissloveAndGlow;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;0;_FinalColorxAlpha;0;Meta Pass;0;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;False;True;True;True;False;;False;0
WireConnection;11;0;8;2
WireConnection;11;1;14;0
WireConnection;12;0;13;0
WireConnection;12;1;11;0
WireConnection;12;2;8;2
...
ASEEND*/
//CHKSM=33A7A65A1516FBCBD6EA0F115F69B42AFF11DB4C